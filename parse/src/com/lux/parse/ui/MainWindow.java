...
public class MainWindow {
    ...
    private void initControlButtons(Composite dataCompoiste) {
        ...
        GridData gridDataButtonComposite = new GridData();
        gridDataButtonComposite.horizontalAlignment = SWT.BEGINNING;
        nextButtonsComposite.setLayoutData(gridDataButtonComposite);
